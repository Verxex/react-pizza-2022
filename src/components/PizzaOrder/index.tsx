  ...
  return (
    <div className="cart__item">
      <div className="cart__item-img">
        <img className="pizza-block__image" src={currentItem.imageUrl} alt={currentItem.title} />
      </div>
      <div className="cart__item-info">
        <h3>{currentItem.title}</h3>
        <p>
          {currentItem.type}, {currentItem.size} см.
        </p>
      </div>
      ...
      <div className="cart__item-price">
        <b>{currentItem.price * currentItem.count} ₽</b>
      </div>
